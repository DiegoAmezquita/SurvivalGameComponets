...
package com.appmunki.survival.android.basegameutils;
...
import com.appmunki.survival.android.AndroidLauncher;
...
public class AndroidGameHelper implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, GameHelper, RoomUpdateListener, RealTimeMessageReceivedListener, RoomStatusUpdateListener, OnInvitationReceivedListener {
     ...
     */
    public AndroidGameHelper(Activity activity, int clientsToUse) {
        mActivity = activity;
    ...
    public void onActivityResult(int requestCode, int responseCode,
        ...
        System.out.println("requestCode " + requestCode + " responseCode " + responseCode);

        if (requestCode == RC_WAITING_ROOM) {
            System.out.println("VUELVE DEL WAITING ROOM");
            ...
            debugLog("onActivityResult: req="
                    ...
                    + com.appmunki.survival.android.basegameutils.GameHelperUtils.activityResponseCodeToString(responseCode));
            ...
            if (responseCode == Activity.RESULT_OK) {
                ...
                debugLog("onAR: responseCode="
                        + com.appmunki.survival.android.basegameutils.GameHelperUtils
    ...
    public void onConnectionFailed(ConnectionResult result) {
        ...
        debugLog("   - code: "
                + com.appmunki.survival.android.basegameutils.GameHelperUtils.errorCodeToString
                (mConnectionResult
                        .getErrorCode()));
    ...
    void giveUp(SignInFailureReason reason) {
        ...
        if (reason.mActivityResultCode == GamesActivityResultCodes.RESULT_APP_MISCONFIGURED) {
            ...
            com.appmunki.survival.android.basegameutils.GameHelperUtils
                    .printMisconfiguredDebugInfo(mAppContext);
        }
    ...
    public static void showFailureDialog(Activity activity, int actResp,
        ...
        switch (actResp) {
            case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED:
                errorDialog = makeSimpleDialog(activity, com.appmunki.survival.
                        android.basegameutils.GameHelperUtils.getString(
                        activity, com.appmunki.survival.android.basegameutils.GameHelperUtils
                                .R_APP_MISCONFIGURED));
                break;
            case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED:
                errorDialog = makeSimpleDialog(activity, com.appmunki.survival.android
                        .basegameutils.GameHelperUtils.getString(
                                activity, com.appmunki.survival.android.basegameutils.GameHelperUtils
                                        .R_SIGN_IN_FAILED));
                break;
            ...
            default:
                ...
                if (errorDialog == null) {
                    ...
                    errorDialog = makeSimpleDialog(
                            activity,
                            com.appmunki.survival.android.basegameutils.GameHelperUtils.getString
                                    (activity,
                                            com.appmunki.survival.android.basegameutils.GameHelperUtils
                                                    .R_UNKNOWN_ERROR)
                                    + " "
    ...
    public static class SignInFailureReason {
        ...
        public String toString() {
            return "SignInFailureReason(serviceErrorCode:"
                    + com.appmunki.survival.
                    android.basegameutils.GameHelperUtils.errorCodeToString(mServiceErrorCode)
    ...
    public String getResourceString(String name) {
        int nameResourceID = mActivity.getResources().getIdentifier(name, "string", mActivity.getApplicationInfo().packageName);
        if (nameResourceID == 0) {
            return null;
        } else {
            return mActivity.getString(nameResourceID);
        }
    }
...
//                   .setSocketCommunicationEnabled(true);
    ...
    public void onRoomCreated(int i, Room room) {
        ...
        androidLauncher.gdxGame.onRoomEvent(Util.EVENT.ROOM_CREATED_SUCCESS, "");
    ...
    public void onRealTimeMessageReceived(RealTimeMessage realTimeMessage) {
        ...
        try {
            System.out.println(Games.Players.getCurrentPlayer(getApiClient()).getDisplayName());
//            if(!actualRoom.getParticipant(realTimeMessage.getSenderParticipantId()).getPlayer().getDisplayName().equals(Games.Players.getCurrentPlayer(getApiClient()).getDisplayName())){
                String message = realTimeMessage.getSenderParticipantId()+"/"+new String(b, "UTF-8");
                androidLauncher.gdxGame.onRoomEvent(Util.EVENT.MESSAGE_RECEIVED, message);
//            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void onPeerInvitedToRoom(Room room, List<String> strings) {
        System.out.print("onPeerInvitedToRoom");
    }

    @Override
    public void onPeerDeclined(Room room, List<String> strings) {
        System.out.print("onPeerDeclined");
    }
    ...
    public void onPeerLeft(Room room, List<String> strings) {
        System.out.print("onPeerLeft");
        androidLauncher.gdxGame.onRoomEvent(Util.EVENT.PEER_LEFT, "");
    }
    ...
    public void onDisconnectedFromRoom(Room room) {
        System.out.print("onDisconnectedFromRoom");
    }

    @Override
    public void onPeersConnected(Room room, List<String> strings) {
        System.out.println("onPeersConnected");
        androidLauncher.gdxGame.onRoomEvent(Util.EVENT.ROOM_JOINED, "");
    }

    @Override
    public void onPeersDisconnected(Room room, List<String> strings) {
        System.out.print("onPeersDisconnected");
    }

    @Override
    public void onP2PConnected(String s) {
        System.out.print("onP2PConnected");
    }

    @Override
    public void onP2PDisconnected(String s) {
        System.out.print("onP2PDisconnected");
    }

    @Override
    public void onInvitationReceived(Invitation invitation) {
        androidLauncher.gdxGame.onRoomEvent(Util.EVENT.INVITATION_RECEIVED, "");
        System.out.print("Notification Received");
        System.out.println("Invitation " + invitation.getInvitationId());
    ...
    public void onInvitationRemoved(String s) {
        System.out.print("onInvitationRemoved");
    }
    ...
    public void showInvitations() {
        Intent intent = Games.Invitations.getInvitationInboxIntent(getApiClient());
        mActivity.startActivityForResult(intent, 124124);
    }


    public void joinRoom(String mIncomingInvitationId) {
        RoomConfig.Builder roomConfigBuilder = makeBasicRoomConfigBuilder();
    ...
    public void sendMessage(String messageText) {
        ...
        for (Participant p : actualRoom.getParticipants()) {
            Games.RealTimeMultiplayer.sendReliableMessage(getApiClient(), null, message,
                    actualRoom.getRoomId(), p.getParticipantId());
        }
    }
    ...
    public void sendUnreliableMessage(String message) {
        ...
        for (Participant p : actualRoom.getParticipants()) {
            Games.RealTimeMultiplayer.sendUnreliableMessage(getApiClient(), messageToSend,
                    actualRoom.getRoomId(), p.getParticipantId());
        }
    }
}