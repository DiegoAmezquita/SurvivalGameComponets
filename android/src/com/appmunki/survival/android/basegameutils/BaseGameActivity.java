...
public abstract class BaseGameActivity extends FragmentActivity implements
       AndroidGameHelper.GameHelperListener {

    // The game helper object. This class is mainly a wrapper around this object.
    protected AndroidGameHelper mHelper;

    // We expose these constants here because we don't want users of this class
    // to have to know about GameHelper at all.
    public static final int CLIENT_GAMES = AndroidGameHelper.CLIENT_GAMES;
    public static final int CLIENT_APPSTATE = AndroidGameHelper.CLIENT_APPSTATE;
    public static final int CLIENT_PLUS = AndroidGameHelper.CLIENT_PLUS;
    public static final int CLIENT_ALL = AndroidGameHelper.CLIENT_ALL;
    ...
    public AndroidGameHelper getGameHelper() {
        if (mHelper == null) {
            mHelper = new AndroidGameHelper(this, mRequestedClients);
    ...
    protected AndroidGameHelper.SignInFailureReason getSignInError() {
